...
public class RiskNoApp extends JFrame implements Runnable,MouseListener, ActionListener
{    
    ...
    boolean rightClick=false,leftClick=false,revoltWin=false, start=false,revoltMode=false, revoltModeHard=false;
    public static void main(String args[])
    {  
        new RiskNoApp().setVisible(true);
    }
    ...
    public void revolt()
    {
        ...
        /*for(Player pp:powerList)
        System.out.println(pp.toString()+ " "+powerList.size());*/
    }
    ...
    {  
        ...
        realms.add(new Section("Jotunheimr",4));//AUTISMO1=0 giants
    ...
    { 
        BufferStrategy bs = getBufferStrategy();/**NEW*/
        if(bs == null) {/**NEW*/
            createBufferStrategy(3);
            return;
        }/**NEW*/
        bg = bs.getDrawGraphics(); /**NEW*/
    ...
    public void giveTroops(Player p)
    {
        ...
        //out=turnP.getColor()+" "+bonus+" "+bridgeBonus+" "+p.territories();
    }
